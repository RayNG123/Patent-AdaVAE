...
class YelpProcessor(DataProcessor):
    ...
    def get_dev_examples(self, data_dir, percentage_per_label=1.0, sample_per_label=0):
        """See base class."""
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "test.txt")), "test", percentage_per_label, sample_per_label)
...
processors = {
    ...
    "wnli": WnliProcessor,
    "yelp": YelpProcessor,
    "rejection_stratified": YelpProcessor,
}
...
output_modes = {
    ...
    "wnli": "classification",
    "yelp": "classification",
    "rejection_stratified": "classification",
}
