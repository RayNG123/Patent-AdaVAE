...
from transformers import GPT2Tokenizer, AdamW, get_linear_schedule_with_warmup, Conv1D
from adapters.configuration_gpt2 import GPT2Config
from adapters.modeling_gpt2 import GPT2LMHeadModel
...
parser.add_argument('--dataset', type=str, default='yelp_data', choices=['yelp_data', 'yahoo_data', 'snli_data', 'claim_data','scientific_title',
...
def train(args):
    ...
    if args.dataset in ['sst-2', 'cola']:
        ...
        if args.dataset in ['yelp_polarity', 'imdb_polarity']:
            ...
            if args.dataset in ['yelp_data', 'claim_data','scientific_title']:
                GDataset = ConditionalGenerationDataset
            else:
